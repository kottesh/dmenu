...
static const char *colors[SchemeLast][2] = {
    ...
    [SchemeSelHighlight] = { "#b0bec5", "#3a3a3a" },  // Light grayish-blue for selected highlight
	[SchemeNormHighlight] = { "#b0bec5", "#222222" }, // Same light grayish-blue for normal highlight
    [SchemeOutHighlight] = { "#c0c0c0", "#4f4f4f" },  // Light gray on darker gray
};
